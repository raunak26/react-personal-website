		...
		<React.Fragment>
			<div className="footer">
				<div className="footer-content">
					...
					<a href="mailto:anandraunak2000@gmail.com" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faEnvelope} className = "faEnvelop footer_logos"></FontAwesomeIcon></a>
